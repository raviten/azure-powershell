...
{	
	...
	{
		Remove-AzDataBoxEdgeStorageAccount $rgname $dfname $edgeStorageAccountName $edgeStorageContainerName
...
{	
	...
	try
	{
		$expected = New-AzDataBoxEdgeStorageContainer $rgname $dfname $edgeStorageAccountName -Name $edgeStorageContainerName -DataFormat BlockBlob
		Remove-AzDataBoxEdgeStorageAccount $rgname $dfname $edgeStorageAccountName $edgeStorageContainerName
		Assert-ThrowsContains { Get-AzDataBoxEdgeShare $rgname $dfname $sharename $edgeStorageAccountName $edgeStorageContainerName} "not find"	
