...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Common.Cmdlets.Alerts
{
    [Cmdlet(VerbsCommon.Get, Constants.Alert, DefaultParameterSetName = ListByParameterSet
     ),
     OutputType(typeof(PSResourceModel)),
    ]
    public class DataBoxEdgeAlertGetCmdletBase : AzureDataBoxEdgeCmdletBase
    {
        ...
        private ResourceModel GetResourceModel()
        {
            return AlertsOperationsExtensions.Get(
                this.DataBoxEdgeManagementClient.Alerts,
                this.DeviceName,
                this.Name,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            WriteObject(ListForEverything(), true);
        }
    }
}